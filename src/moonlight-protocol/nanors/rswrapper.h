...
#define reed_solomon_encode_fn reed_solomon_encode
#define reed_solomon_decode_fn reed_solomon_decode
#define reed_solomon_new_fn reed_solomon_new
#define reed_solomon_release_fn reed_solomon_release
